...
const IconCard = ({ boxText, IconName, url }: iconcardType) => {
	return (
		<Link
			href={url}
			className='flex justify-center items-center shadow-sm rounded-[10px] dark:bg-[var(--card-bg-dark)]  md:w-[120px] w-[100px] py-[24px] gap-2 cursor-pointer px-[8px] md:h-[120px] mb-4 border-[var(--primary)] dark:border-[var(--greys)] hover:-translate-y-2 ease-in duration-1000 transition-transform border-2'>
